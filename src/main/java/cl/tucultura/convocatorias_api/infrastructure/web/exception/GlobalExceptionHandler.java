...
import cl.tucultura.convocatorias_api.domain.exception.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleFechaCierreInvalida(FechaCierreInvalidaException ex) {
